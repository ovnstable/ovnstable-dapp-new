...
export const ABI_PortfolioManager = [
  {
    inputs: [],
    stateMutability: 'nonpayable',
    type: 'constructor',
...
export const ABI_WethPlus = [{ inputs: [{ internalType: 'address', name: '_logic', type: 'address' }, { internalType: 'bytes', name: '_data', type: 'bytes' }], stateMutability: 'payable', type: 'constructor' }, {
  anonymous: false,
  inputs: [{
...
export const EXCHANGER_INSURANCE_ABI = [
  {
    inputs: [],
    stateMutability: 'nonpayable',
    type: 'constructor',
