    ...
    return {
      ...
      faqData: {
        bronze: [
          ...
          'Task "Hold at least 2 share of OVN at Districtone.io", indicates you need to buy/hold OVN share, which you can buy at Districtone.io',
        ...
        bronzePools: [
          ...
          {
            link: 'https://districtone.io/space/3147?inviteCode=50YVAZ',
            text: 'Districtone.io',
          },
        ],
        silver: [
